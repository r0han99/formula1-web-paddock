...
def about_cs():
    ...
    cols[1].markdown(f'''<p style='font-family:syne;'; font-size:18px;><span style='font-weight:normal;'>Engineered by</span> <u style='font-size:22px; font-weight:900; color:orange;'>rohan</u> <a href='https://github.com/r0han99'> <img src='data:image/png;base64,{img_to_bytes('./assets/github.png')}' class='img-fluid' width=35> </a></p>''',unsafe_allow_html=True)
